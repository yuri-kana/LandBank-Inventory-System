...
async function loadInventoryItems() {
    try {
        const response = await fetch('<?php echo e(route("admin.items.restock.bulk")); ?>');
...
async function submitRestock() {
    ...
    try {
        const response = await fetch('<?php echo e(route("admin.items.restock.bulk.process")); ?>', {
            method: 'POST',
            body: formData
        });
...
</script><?php /**PATH C:\Users\Jhon Rhey\Downloads\Land Bank Inventory System\Land Bank Inventory System\inventory-system\resources\views\components\modals\start-restocking.blade.php ENDPATH**/ ?>