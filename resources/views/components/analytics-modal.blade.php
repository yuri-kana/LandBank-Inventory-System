                                                ...
                                                <div class="p-4 hover:bg-gray-50 transition duration-150">
                                                    <div class="flex items-center justify-between">
                                                        <div class="flex items-center flex-1">
                                                            ...
                                                            <div class="flex-1 min-w-0">
                                                                ...
                                                                <div class="text-sm text-gray-500">{{ $item->total_requests }} requests</div>
                                                            </div>
                                                        </div>
                                                        <div class="ml-4">
                                                            <div class="text-sm font-medium {{ $item->total_requests > 20 ? 'text-red-600' : ($item->total_requests > 10 ? 'text-amber-600' : 'text-emerald-600') }}">
                                                    ...
                                                    <div class="mt-3">
                                                        <div class="flex justify-between text-xs text-gray-500 mb-1">
                                                            ...
                                                            <span>{{ number_format($item->avg_requests_per_day, 1) }}/day</span>
                                                        </div>
                                                ...
                                                @foreach($usageTrends ?? [] as $trend)
                                                    <div>
                                                        <div class="flex justify-between items-center mb-2">
                                                            <div class="font-medium text-gray-900">{{ $trend['category'] }}</div>
                                                            <div class="text-sm font-medium {{ $trend['trend'] === 'increasing' ? 'text-red-600' : ($trend['trend'] === 'decreasing' ? 'text-emerald-600' : 'text-gray-600') }}">
                                                                {{ $trend['percentage'] }}% {{ $trend['trend'] }}
                                                            </div>
                                                        </div>
                                                        <div class="w-full bg-gray-200 rounded-full h-2">
                                                            <div class="bg-blue-500 h-2 rounded-full" style="width: {{ $trend['percentage'] }}%"></div>
                                                        </div>
                                                        <div class="flex justify-between text-xs text-gray-500 mt-1">
                                                            <span>Last week: {{ $trend['last_week'] }} requests</span>
                                                            <span>This week: {{ $trend['this_week'] }} requests</span>
                                                        </div>
                                                    </div>
                                                @endforeach
                                            </div>
                                            <div class="mt-6 p-4 bg-gray-50 rounded-lg">
                                                <div class="flex items-center">
                                                    ...
                                                    <p class="text-sm text-gray-700">
                                                        <strong>Insight:</strong> {{ $usageInsight ?? 'Analyze request patterns to optimize inventory levels' }}
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="divide-y divide-gray-200 max-h-96 overflow-y-auto">
                                            @forelse($fastDepletingItems ?? [] as $item)
                                                <div class="p-4 hover:bg-gray-50 transition duration-150">
                                                    <div class="flex items-center justify-between">
                                                        <div class="flex items-center">
                                                            <div class="p-2 rounded-lg {{ $item->depletion_rate > 50 ? 'bg-red-100 text-red-600' : 'bg-amber-100 text-amber-600' }} mr-3">
                                                                <i class="fas fa-bolt"></i>
                                                            </div>
                                                            <div>
                                                                <div class="font-medium text-gray-900">{{ $item->name }}</div>
                                                                <div class="text-sm text-gray-500">Current: {{ $item->quantity }} | Min: {{ $item->minimum_stock }}</div>
                                                            </div>
                                                        </div>
                                                        <div class="text-right">
                                                            <div class="text-lg font-bold {{ $item->depletion_rate > 50 ? 'text-red-600' : 'text-amber-600' }}">
                                                    ...
                                                    <div class="mt-3">
                                                        <div class="flex justify-between text-xs text-gray-500 mb-1">
                                                            ...
                                                            <span class="font-medium {{ $item->days_to_depletion <= 7 ? 'text-red-600' : ($item->days_to_depletion <= 14 ? 'text-amber-600' : 'text-emerald-600') }}">
                                                                {{ $item->days_to_depletion }} days
                                                            </span>
                                                        </div>
                                                        <div class="w-full bg-gray-200 rounded-full h-2">
                                                            <div class="{{ $item->depletion_rate > 50 ? 'bg-red-500' : 'bg-amber-500' }} h-2 rounded-full" style="width: {{ min($item->depletion_rate, 100) }}%"></div>
                                                        </div>
                                                    </div>
                                                </div>
                                            @empty
                                                ...
                                                <div class="flex items-start">
                                                    ...
                                                    <div>
                                                        ...
                                                        <p class="text-xs text-gray-600">
                                                            {{ $criticalItemsCount ?? 0 }} items will run out within a week based on current usage rates.
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="bg-white rounded-lg border border-gray-200">
                                    <div class="px-4 py-3 border-b border-gray-200 bg-gray-50 flex justify-between items-center">
                                        <div>
                                            ...
                                            <p class="text-sm text-gray-500 mt-1">{{ $totalItems ?? 0 }} items • {{ $totalValue ?? 0 }} total value</p>
                                        </div>
                                    </div>
                                    <div class="overflow-x-auto">
                                        <table class="min-w-full divide-y divide-gray-200">
                                            ...
                                            <tbody class="bg-white divide-y divide-gray-200" id="inventory-table-body">
                                                @foreach($allItems ?? [] as $item)
                                                    ...
                                                    @endphp
                                                    <tr class="inventory-row hover:bg-gray-50" data-status="{{ $stockStatus }}">
                                                        <td class="px-6 py-4 whitespace-nowrap">
                                                            <div class="flex items-center">
                                                        ...
                                                        <td class="px-6 py-4 whitespace-nowrap">
                                                            <div class="text-sm text-gray-900">{{ $requestsCount }}</div>
                                                            <div class="text-xs {{ $requestsCount > 20 ? 'text-red-600' : ($requestsCount > 10 ? 'text-amber-600' : 'text-gray-500') }}">
                                                                @if($requestsCount > 20)
                                                                    High demand
                                                                @elseif($requestsCount > 10)
                                                                    Medium demand
                                                                @else
                                                                    Low demand
                                                                @endif
                                                        ...
                                                        <td class="px-6 py-4 whitespace-nowrap">
                                                            <div class="flex items-center">
                                                                <div class="w-24 bg-gray-200 rounded-full h-2 mr-2">
                                                                    <div class="bg-blue-500 h-2 rounded-full" style="width: {{ min($turnoverRate, 100) }}%"></div>
                                                                </div>
                                                                <span class="text-sm text-gray-900">{{ number_format($turnoverRate, 1) }}%</span>
                                                            </div>
                                                        </td>
