            ...
            <p class="text-sm text-gray-500 mt-1">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($depletion_period_info)): ?>
                    ...
                    <span class="text-xs bg-blue-100 text-blue-800 px-2 py-1 rounded ml-2">
                        Monthly Reset • Based on Actual Consumption
                    </span>
                <?php else: ?>
                    Current Month Consumption Analysis
        ...
        <div class="divide-y divide-gray-200 max-h-96 overflow-y-auto">
                ...
                <div class="p-4 hover:bg-gray-50 transition duration-150">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center">
                            ...
                            <div>
                                ...
                                <div class="text-sm text-gray-500">
                                    Current: <?php echo e($item->quantity); ?> | Min: <?php echo e($item->minimum_stock); ?>

                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($item->claimed_this_month > 0): ?>
                                        <span class="text-xs text-blue-600 ml-2">
                                            (Used: <?php echo e($item->claimed_this_month); ?> this month)
                                        </span>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </div>
                            </div>
                        ...
                        <div class="text-right">
                            ...
                            <div class="text-xs text-gray-500">monthly depletion</div>
                        </div>
                    </div>
                    <div class="mt-3">
            ...
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                <div class="p-6 text-center text-gray-500">
                    ...
                    <p>No depletion data available this month</p>
                    <p class="text-sm mt-2 text-gray-400">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($depletion_period_info)): ?>
                            Data based on <?php echo e($depletion_period_info['month_name']); ?> consumption
                        <?php else: ?>
                            Try making some claims to see depletion analysis
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </p>
    ...
    <div class="bg-white rounded-lg border border-gray-200">
        ...
        <div class="p-6">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($fastDepletingItems) && count($fastDepletingItems) > 0): ?>
                ...
                ?>
                <div class="mb-6">
                    <h5 class="font-medium text-gray-700 mb-3">Monthly Depletion Status</h5>
...
</div><?php /**PATH C:\Users\Jhon Rhey\Downloads\inventory-system\resources\views/tabs/depletion-rate.blade.php ENDPATH**/ ?>