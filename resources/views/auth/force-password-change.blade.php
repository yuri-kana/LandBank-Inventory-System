...
<head>
    ...
    <title>{{ config('app.name', 'Inventory System') }} - Change Password</title>
    ...
    <div class="min-h-screen flex flex-col sm:justify-center items-center px-4 sm:px-0">
        <div class="w-full max-w-md login-card">
            ...
            <div class="py-4">
                ...
                <form method="POST" action="{{ route('password.force-change.store') }}" class="space-y-4" id="passwordChangeForm">
                    @csrf
