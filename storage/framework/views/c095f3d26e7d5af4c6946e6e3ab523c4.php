    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->check() && auth()->user()->isAdmin()): ?>
        ...
        <div class="py-8">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <?php
                    $totalItems = $totalItems ?? \App\Models\Item::count();
                    $lowStockItems = $lowStockItems ?? \App\Models\Item::whereColumn('quantity', '<=', 'minimum_stock')
                        ->where('quantity', '>', 0)
                        ->count();
                    $outOfStockItems = $outOfStockItems ?? \App\Models\Item::where('quantity', '<=', 0)->count();
                    $criticalItemsCount = $outOfStockItems ?? 0;
                    $warningItemsCount = $lowStockItems ?? 0;
                    $safeItemsCount = $totalItems - ($lowStockItems + $outOfStockItems);
                    
                    // Year context for stats
                    $yearContext = $selectedYear == 'all' ? 'All Time' : $selectedYear;
                ?>
                        ...
                        <div class="bg-gradient-to-r from-blue-50 to-blue-100 border border-blue-200 rounded-lg p-6 shadow-md hover:shadow-lg transition duration-300">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    ...
                                    <p class="text-xs text-blue-700 mt-1"><?php echo e($safeItemsCount); ?> in stock</p>
                                    <p class="text-xs text-blue-500 mt-1">For <?php echo e($yearContext); ?></p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-gradient-to-r from-yellow-50 to-yellow-100 border border-yellow-200 rounded-lg p-6 shadow-md hover:shadow-lg transition duration-300">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    ...
                                    <p class="text-2xl font-bold text-yellow-700"><?php echo e($lowStockItems); ?></p>
                                    <p class="text-xs text-yellow-700 mt-1">Below minimum stock</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-gradient-to-r from-red-50 to-red-100 border border-red-200 rounded-lg p-6 shadow-md hover:shadow-lg transition duration-300">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    ...
                                    <p class="text-2xl font-bold text-red-700"><?php echo e($outOfStockItems); ?></p>
                                    <p class="text-xs text-red-700 mt-1">Require immediate attention</p>
                                </div>
                            </div>
                        </div>

                        <!-- Year Summary Card -->
                        <div class="bg-gradient-to-r from-green-50 to-emerald-100 border border-green-200 rounded-lg p-6 shadow-md hover:shadow-lg transition duration-300">
                            <div class="flex items-center">
                                <div class="p-3 rounded-full bg-green-200 text-green-700">
                                    <i class="fas fa-calendar-alt text-xl"></i>
                                </div>
                                <div class="ml-4">
                                    <p class="text-sm font-medium text-green-900">Period Summary</p>
                                    <p class="text-2xl font-bold text-green-700"><?php echo e($totalRequests ?? 0); ?></p>
                                    <p class="text-xs text-green-700 mt-1">
                                        <?php echo e($yearContext == 'All Time' ? 'Total Requests' : 'Requests in ' . $yearContext); ?>
                        ...
                        <div class="divide-y divide-gray-100">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = ($recentTeamRequests ?? collect())->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $request): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <div class="p-4 hover:bg-gray-50 transition duration-150">
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($request->status === 'approved' && !$request->is_claimed): ?>
                                        <div class="mt-3">
                                            <form action="<?php echo e(route('requests.claim', $request)); ?>" method="POST">
                                                <?php echo csrf_field(); ?>
                                                <button type="submit" class="text-sm bg-blue-100 hover:bg-blue-200 text-blue-700 px-3 py-1 rounded-lg transition duration-200">
...
<?php echo $__env->make('components.modals.report-not-generated', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Jhon Rhey\Downloads\inventory-system\resources\views/dashboard.blade.php ENDPATH**/ ?>