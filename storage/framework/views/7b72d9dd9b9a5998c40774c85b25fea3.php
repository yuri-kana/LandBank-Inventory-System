...
<body>
    ...
    <div class="section">
        ...
        <div class="summary-box">
            <table>
                <tr>
                    <td width="33%"><strong>Total Requests:</strong> <?php echo e(number_format($totalRequests)); ?></td>
    ...
    <!-- Most Active Teams -->
    <div class="section">
        <div class="section-title">👥 Most Teams Requested</div>
        <table>
            <thead>
                <tr>
                    <th>TEAM</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-right"><?php echo e(number_format($team->members_count)); ?></td>
                    <td class="text-right"><?php echo e(number_format($team->request_count)); ?></td>
                    <td class="text-right">
                        <?php
                ...
                <!-- TOTAL ROW for Most Active Teams -->
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($mostActiveTeams->count() > 0): ?>
                <tr class="total-row">
                    <td><strong>TOTAL</strong></td>
                    <td class="text-right"><strong><?php echo e(number_format($mostActiveTeams->sum('members_count'))); ?></strong></td>
                    <td class="text-right"><strong><?php echo e(number_format($mostActiveTeams->sum('request_count'))); ?></strong></td>
                    <td class="text-right">
                        <?php
                            $totalRequests = $mostActiveTeams->sum('request_count');
                            $maxRequests = $mostActiveTeams->max('request_count');
                            $avgPercentage = $maxRequests > 0 ? ($totalRequests / ($maxRequests * $mostActiveTeams->count())) * 100 : 0;
                        ?>
...
</html><?php /**PATH C:\Users\Jhon Rhey\Downloads\inventory-system\resources\views/reports/pdf/monthly.blade.php ENDPATH**/ ?>