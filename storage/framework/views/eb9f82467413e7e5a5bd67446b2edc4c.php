...
<?php $__env->startSection('title', 'Teams - Inventory System'); ?>
     ...
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                <?php echo e(__('Teams Management')); ?>

            </h2>
            <a href="<?php echo e(route('admin.teams.create')); ?>" class="bg-blue-600 text-white px-4 py-2 rounded-md hover:bg-blue-700">
                Add New Team
            </a>
        </div>
     <?php $__env->endSlot(); ?>
                            ...
                            <div class="border border-gray-200 rounded-lg p-6 hover:shadow-md transition-shadow duration-300 flex flex-col h-full">
                                ...
                                <div class="flex justify-between items-start mb-4">
                                    <div class="flex-1 min-w-0">
                                        <h3 class="text-lg font-semibold text-gray-900 truncate" title="<?php echo e($team->name); ?>">
                                            <?php echo e($team->name); ?>

                                        </h3>
                                        <p class="text-sm text-gray-500 mt-1">
                                            <i class="fas fa-users mr-1"></i> 
                                            <?php echo e($team->users->count()); ?> member<?php echo e($team->users->count() !== 1 ? 's' : ''); ?>
                                    ...
                                    <div class="flex space-x-2 ml-2 flex-shrink-0">
                                        ...
                                        <button type="button" 
                                                onclick="openManageMembersModal('<?php echo e($team->id); ?>', '<?php echo e($team->name); ?>', <?php echo e($team->users->count()); ?>)"
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($team->users->count() == 0): ?>
                                            <button type="button" 
                                                    onclick="openDeleteTeamModal('<?php echo e($team->id); ?>', '<?php echo e($team->name); ?>')"
                                ...
                                <?php if($team->users->count() > 0): ?>
                                    <div class="border-t border-gray-100 pt-4 flex-grow">
                                        ...
                                        <ul class="space-y-3">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $team->users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <li class="flex items-center justify-between">
                                                    <div class="flex items-center flex-1 min-w-0">
                                                        <!-- Profile Photo - Clickable -->
                                                        <div class="relative flex-shrink-0 mr-3 cursor-pointer" 
                                                             onclick="viewProfilePhoto('<?php echo e($user->profile_photo_path ? Storage::url($user->profile_photo_path) : "https://ui-avatars.com/api/?name=" . urlencode($user->name) . "&background=4f46e5&color=ffffff&size=512"); ?>', '<?php echo e($user->name); ?>')">
                                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($user->profile_photo_path): ?>
                                                                <img src="<?php echo e(Storage::url($user->profile_photo_path)); ?>" 
                                                                    ...
                                                                    onerror="this.onerror=null; this.src='https://ui-avatars.com/api/?name=<?php echo e(urlencode($user->name)); ?>&background=4f46e5&color=ffffff&size=32'">
                                                            <?php else: ?>
                                                            ...
                                                            <!-- Status indicator -->
                                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($user->hasVerifiedEmail() && $user->is_active): ?>
                                                        ...
                                                        <div class="flex-1 min-w-0">
                                                            <div class="flex items-center justify-between">
                                                                <div class="flex items-center flex-wrap gap-1">
                                                                    <span class="text-sm text-gray-900 font-medium truncate" title="<?php echo e($user->name); ?>">
                                                                        <?php echo e($user->name); ?>

                                                                    </span>
                                                                    <span class="text-xs text-gray-500 truncate" title="<?php echo e($user->email); ?>">
                                ...
                                <div class="border-t border-gray-100 pt-4 mt-4">
                                    <p class="text-sm text-gray-600">
                                        ...
                                        Created <?php echo e($team->created_at->diffForHumans()); ?>
...
<?php endif; ?><?php /**PATH C:\Users\Jhon Rhey\Downloads\Land Bank Inventory System\Land Bank Inventory System\inventory-system\resources\views/teams/index.blade.php ENDPATH**/ ?>