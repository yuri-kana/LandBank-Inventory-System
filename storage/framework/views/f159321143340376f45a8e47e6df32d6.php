...
<?php $component->withAttributes([]); ?>
        ...
        <div class="max-w-full mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    ...
                    <!-- Table Container - Removed overflow-x-auto and adjusted table width -->
                                            ...
                                            <td class="px-4 py-4 whitespace-nowrap text-sm font-medium">
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($request->status === 'pending'): ?>
                                                    <div class="flex flex-col sm:flex-row sm:space-x-2 space-y-1 sm:space-y-0">
                                                        ...
                                                        <button onclick="showAdminNotesModal('<?php echo e($request->id); ?>', 'rejected')" 
                                                ...
                                                <?php elseif($request->status === 'approved'): ?>
                                                    <!-- CLAIM BUTTON - FIXED to use admin route -->
                                                    <form action="<?php echo e(route('admin.requests.claim', $request)); ?>" method="POST" class="inline w-full">
                                                        <?php echo csrf_field(); ?>
                                                        <button type="submit" 
                                                                ...
                                                                onclick="return confirm('Are you sure you want to claim <?php echo e($request->quantity_requested); ?> <?php echo e($request->item->unit ?? 'units'); ?> of <?php echo e($request->item->name); ?>?\\n\\nThis will deduct stock from inventory.')">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Check if claim buttons exist and log their actions
        const claimButtons = document.querySelectorAll('form[action*="/claim"] button');
        claimButtons.forEach((button, index) => {
            const form = button.closest('form');
            console.log(`Claim button ${index + 1}:`, {
                action: form.action,
                method: form.method,
        ...
        const form = document.getElementById('adminNotesForm');
        if (form) {
            console.log('Admin notes form found');
        }
    });
    </script>
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
...
<?php endif; ?><?php /**PATH C:\Users\Jhon Rhey\Downloads\inventory-system\resources\views/requests/index.blade.php ENDPATH**/ ?>