<div class="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
            ...
            <div class="flex items-center space-x-3">
                            ...
                            <select id="year-select" name="year" 
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $availableYears; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $year): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($year); ?>" <?php echo e($year == $selectedYear ? 'selected' : ''); ?>>
                                        <?php echo e($year === 'all' ? 'All Time' : $year); ?>
                ...
                <div class="flex items-center space-x-2">
                    ...
                    <button onclick="navigateYear('next')" 
                            class="p-2 text-gray-600 hover:text-blue-600 hover:bg-blue-50 rounded-lg transition-colors"
                            title="Next Year"
                            <?php echo e($selectedYear >= date('Y') || $selectedYear === 'all' ? 'disabled' : ''); ?>>
    ...
    <!-- Stats Cards Row - Updated with Items Claimed -->
            ...
            <div class="bg-white rounded-lg p-4 border border-gray-200">
                <div class="flex items-center">
                    ...
                    <div>
                        ...
                        <p class="text-xl font-semibold text-gray-900"><?php echo e(number_format($totalClaimed)); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg p-4 border border-gray-200">
                <div class="flex items-center">
                    ...
                    <div>
                        ...
                        <p class="text-xl font-semibold text-gray-900"><?php echo e($averageActivity); ?></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr class="hover:bg-blue-50 transition-colors">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap">
                        <div class="flex items-center">
                            <span class="font-medium text-gray-900 mr-2"><?php echo e($report->total_requests); ?></span>
                            <span class="text-xs text-gray-500">Approved requests</span>
                        </div>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap">
                        <div class="flex items-center">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap">
                        <div class="flex items-center space-x-2">
                            <!-- View Details Button -->
                            <button onclick="viewReportDetails(<?php echo e($report->year); ?>, <?php echo e($report->month); ?>)" 
                                    class="view-report-details p-2 text-gray-600 hover:text-blue-600 hover:bg-blue-50 rounded-lg transition-colors" 
                                    title="View Details">
...
</script><?php /**PATH C:\Users\Jhon Rhey\Downloads\inventory-system\resources\views/tabs/inventory-records.blade.php ENDPATH**/ ?>