                        ...
                        <div class="max-h-[500px] overflow-y-auto divide-y divide-gray-100" id="inventory-scroll-container">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $availableItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <div class="p-4 hover:bg-gray-50 transition duration-150 inventory-item border-l-4 
                                    ...
                                    <?php elseif($item->quantity <= $item->minimum_stock * 2): ?>
                                        ...
                                        <div class="flex-1">
                                            ...
                                            <div class="grid grid-cols-1 md:grid-cols-3 gap-2 mt-2">
                                                ...
                                                <div class="flex items-center">
                                                    ...
                                                    <span class="ml-2 text-sm font-medium text-gray-700"><?php echo e($item->minimum_stock); ?></span>
                                                </div>
                                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($item->reorder_point > 0): ?>
                                                <div class="flex items-center">
                                                    <i class="fas fa-flag text-gray-400 text-sm mr-2"></i>
                                                    <span class="text-sm text-gray-600">Reorder At:</span>
                                                    <span class="ml-2 text-sm font-medium text-gray-700"><?php echo e($item->reorder_point); ?></span>
                                                </div>
                                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                            </div>
                                            
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($item->location): ?>
                                                <div class="flex items-center mt-2">
                                                    <i class="fas fa-map-marker-alt text-gray-400 text-xs mr-2"></i>
                                                    <span class="text-xs text-gray-500"><?php echo e($item->location); ?></span>
                                                </div>
                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        </div>
                                            ...
                                            <div class="mt-2 w-24 h-2 bg-gray-200 rounded-full overflow-hidden">
                                                <div class="h-full rounded-full
                                                    ...
                                                    <?php else: ?>
                                                        bg-emerald-500
                                                    <?php endif; ?>"
                                                    style="width: <?php echo e(min(100, ($item->quantity / max($item->maximum_stock ?? $item->minimum_stock * 5, 1)) * 100)); ?>%">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="mt-3 flex justify-between items-center">
                                            ...
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->check() && auth()->user()->isAdmin()): ?>
                                                <div class="text-xs text-gray-500">
                                                    Last restocked: <?php echo e($item->updated_at->diffForHumans()); ?>
