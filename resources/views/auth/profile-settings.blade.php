{{-- views/auth/profile-settings.blade.php --}}
@section('title', 'Profile Settings - Inventory System')
...
<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('dashboard') }}" class="text-sm text-emerald-600 hover:text-emerald-800">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                            ...
                            <div class="text-center">
                                ...
                                <div class="relative mx-auto w-32 h-32 mb-4">
                                    <div class="w-full h-full rounded-full bg-white border-4 border-white shadow-lg overflow-hidden relative group">
                                        ...
                                        <div id="default-profile-icon" class="w-full h-full {{ $hasPhoto ? 'hidden' : 'flex' }} bg-emerald-100 items-center justify-center">
                                ...
                                <p class="text-emerald-100 text-sm mt-1">{{ auth()->user()->email }}</p>
                            </div>
                        </div>
                            ...
                            <div class="space-y-4">
                                ...
                                <div>
                                    ...
                                    <div class="flex items-center mt-1">
                                        ...
                                        <span class="text-gray-900">{{ auth()->user()->team->name }}</span>
                                    </div>
                                </div>
                                @endif
                ...
                <div class="lg:col-span-2 space-y-8">
                    ...
                    <div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
                        ...
                        <div class="p-6">
                            <form method="POST" action="{{ route('profile.password.update') }}" class="space-y-6" id="password-form">
                                @csrf
                                @method('PUT')
    ...
    <form id="profile-photo-form" method="POST" action="{{ route('profile.photo.update') }}" enctype="multipart/form-data" class="hidden">
        @csrf
        @method('PUT')
        <input type="file" 
