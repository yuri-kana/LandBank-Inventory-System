@section('title', 'Create New Team - Inventory System')
        ...
        <div class="flex justify-between items-center">
            <div>
                <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                    <i class="fas fa-users mr-2 text-emerald-600"></i> {{ __('Create New Team') }}
                </h2>
    ...
    <div class="py-8">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-lg sm:rounded-xl border border-gray-100 hover:shadow-xl transition-shadow duration-300">
                ...
                <!-- Form Content -->
                <div class="p-6">
                    <form method="POST" action="{{ route('admin.teams.store') }}" id="teamForm">
                        @csrf
