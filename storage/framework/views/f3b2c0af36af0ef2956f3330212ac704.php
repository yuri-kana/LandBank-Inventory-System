<div class="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
            ...
            <div>
                ...
                <div class="flex items-center mt-2 space-x-4">
                    <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-blue-100 text-blue-800">
                        ...
                        <?php echo e($totalItems ?? 0); ?> Total Items
                    </span>
                    <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-green-100 text-green-800">
                        <i class="fas fa-calendar-alt mr-1"></i>
                        Viewing <?php echo e($selectedYear === 'all' ? 'All Time' : $selectedYear); ?>
    ...
    <div class="relative">
        <form method="GET" action="<?php echo e(route('dashboard', ['tab' => 'inventory-records'])); ?>" id="year-filter-form" class="flex items-center">
            ...
            <div class="relative">
                <select id="year-select" name="year" 
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $availableYears; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $year): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($year < $currentYear): ?>
                        ...
                        <?php elseif($year == $currentYear): ?>
                            ...
                            <option value="<?php echo e($year); ?>" <?php echo e($year == $selectedYear ? 'selected' : ''); ?>>
                                <?php echo e($year); ?> (Current)
                            </option>
                        <?php elseif($year == $nextYear): ?>
                            <!-- Next year (2027) - conditionally disabled -->
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isCurrentYearFinished || $isNextYearStarted): ?>
                            ...
                            <?php else: ?>
                                ...
                                <option value="<?php echo e($year); ?>" disabled class="text-gray-400 bg-gray-100">
                                    <?php echo e($year); ?> (Available Jan 1, <?php echo e($nextYear); ?>)
                                </option>
                            <?php endif; ?>
                        <?php elseif($year > $nextYear): ?>
                            ...
                            ?>
                            <option value="<?php echo e($year); ?>" disabled class="text-gray-400 bg-gray-100">
                                <?php echo e($year); ?> (Available in <?php echo e($yearsAway); ?> year<?php echo e($yearsAway > 1 ? 's' : ''); ?>)
                            </option>
    ...
    <div class="flex items-center space-x-2">
        ...
        <button onclick="navigateYear('next')" 
                class="p-2 text-gray-600 hover:text-blue-600 hover:bg-blue-50 rounded-lg transition-colors"
                title="Next Year"
                <?php echo e($selectedYear >= date('Y') ? 'disabled' : ''); ?>>
            ...
            <div class="bg-white rounded-lg p-4 border border-gray-200 w-full max-w-xs">
                <div class="flex items-center">
                    ...
                    <div>
                        ...
                        <p class="text-xl font-semibold text-gray-900"><?php echo e(number_format($totalRequests)); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg p-4 border border-gray-200 w-full max-w-xs">
                <div class="flex items-center">
                    ...
                    <div>
                        ...
                        <p class="text-xl font-semibold <?php echo e($totalRestocked > 0 ? 'text-green-600' : 'text-gray-900'); ?>">
                            <?php echo e($totalRestocked > 0 ? '+' : ''); ?><?php echo e(number_format($totalRestocked)); ?>
                    ...
                    <div class="p-2 rounded-lg bg-purple-100 text-purple-600 mr-3">
                     ...
                     <div>
                        ...
                        <p class="text-xl font-semibold text-gray-900">
                            ...
                            ?>
                            <?php echo e(number_format($sumClaimed)); ?>
    ...
    <div class="w-full">
        <table class="w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $monthlyReports; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $report): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <?php
                ...
                <tr class="hover:bg-blue-50 transition-colors">
                    <td class="px-6 py-4 w-1/6">
                        <div class="flex items-center">
                            ...
                            <div>
                                <div class="font-medium text-gray-900"><?php echo e($period); ?></div>
                                <div class="text-xs <?php echo e($isFinalized ? 'text-green-600 bg-green-50' : 'text-yellow-600 bg-yellow-50'); ?> px-2 py-1 rounded-full inline-block mt-1">
                    ...
                    <td class="px-6 py-4 w-1/6">
                        <div class="flex items-center">
                            <span class="font-medium text-gray-900 mr-2"><?php echo e($report->total_requests ?? 0); ?></span>
                            <span class="text-xs text-gray-500 mt-1">Requests made</span>
                        </div>
                    </td>
                    <td class="px-6 py-4 w-1/6">
                        <div class="flex items-center">
                            <span class="font-medium <?php echo e($report->total_restocked > 0 ? 'text-green-600' : 'text-gray-900'); ?> mr-2">
                                <?php echo e($report->total_restocked > 0 ? '+' : ''); ?><?php echo e($report->total_restocked); ?>
                    ...
                    <td class="px-6 py-4 w-1/6">
                        <div class="flex items-center">
                            <span class="font-medium text-gray-900 mr-2"><?php echo e($report->total_claimed); ?></span>
                    ...
                    <td class="px-6 py-4 w-1/6">
                        <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium <?php echo e($statusColor); ?>">
                            <i class="<?php echo e($statusIcon); ?> mr-1"></i>
                            <?php echo e($report->status); ?>

                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$hasMonthEnded): ?>
                        ...
                        <div class="flex items-center space-x-2">
                            ...
                            <div class="relative">
                                ...
                                <div class="monthly-report-dropdown absolute right-0 mt-1 w-40 bg-white rounded-lg shadow-lg border border-gray-200 z-10 hidden">
                                    <div class="p-2">
                                        <button onclick="downloadReport('pdf', <?php echo e($report->year); ?>, <?php echo e($report->month); ?>, '<?php echo e($monthName); ?>')"
                                        ...
                                        <button onclick="downloadReport('excel', <?php echo e($report->year); ?>, <?php echo e($report->month); ?>, '<?php echo e($monthName); ?>')"
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showFinalizeButton): ?>
                            <button onclick="finalizeReport(<?php echo e($report->year); ?>, <?php echo e($report->month); ?>)" 
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$hasMonthEnded && !$isFinalized): ?>
                            <div class="relative group">
                                ...
                                <div class="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 px-2 py-1 bg-gray-800 text-white text-xs rounded opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap z-10">
                                    Can finalize after <?php echo e($monthEndDate->format('F j, Y')); ?>
    ...
    <div class="px-6 py-4 border-t border-gray-200 bg-gray-50">
        <div class="flex flex-col sm:flex-row justify-between items-center space-y-3 sm:space-y-0">
            <div class="text-sm text-gray-600">
                Showing <span class="font-medium"><?php echo e(count($monthlyReports)); ?></span> monthly reports for 
                <span class="font-medium"><?php echo e($selectedYear === 'all' ? 'All Time' : $selectedYear); ?></span>
            </div>
            <div class="text-xs text-gray-500">
                Data as of <?php echo e(now()->format('F j, Y g:i A')); ?>
    ...
    <div class="p-6">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div class="p-4 border border-gray-200 rounded-lg">
                <div class="text-sm text-gray-500 mb-2"><?php echo e($yearlyComparison['previous_year']['year'] ?? ($selectedYear - 1)); ?> Total Requests</div>
                <div class="text-2xl font-bold text-gray-900"><?php echo e(number_format($yearlyComparison['previous_year']['total_requests'] ?? 0)); ?></div>
                <div class="text-xs text-gray-500 mt-1">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(($yearlyComparison['previous_year']['total_requests'] ?? 0) > 0): ?>
                        <?php echo e($yearlyComparison['previous_year']['most_requested_item']['name'] ?? 'No data'); ?> was most requested
                    <?php else: ?>
                        No data available
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </div>
            ...
            <div class="p-4 border border-gray-200 rounded-lg">
                <div class="text-sm text-gray-500 mb-2"><?php echo e($selectedYear); ?> YTD Requests</div>
                <div class="text-2xl font-bold text-gray-900"><?php echo e(number_format($yearlyComparison['current_year']['total_requests'] ?? 0)); ?></div>
                <div class="text-xs <?php echo e($yearlyComparison['comparison']['direction'] == 'up' ? 'text-green-600' : ($yearlyComparison['comparison']['direction'] == 'down' ? 'text-red-600' : 'text-gray-600')); ?> mt-1">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(($yearlyComparison['previous_year']['total_requests'] ?? 0) > 0): ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($yearlyComparison['comparison']['direction'] == 'up'): ?>
                            <i class="fas fa-arrow-up mr-1"></i>
                        <?php elseif($yearlyComparison['comparison']['direction'] == 'down'): ?>
                            <i class="fas fa-arrow-down mr-1"></i>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        <?php echo e(number_format($yearlyComparison['comparison']['change'] ?? 0, 1)); ?>% from last year
                    <?php else: ?>
                        Year to Date
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </div>
            ...
            <div class="p-4 border border-gray-200 rounded-lg">
                ...
                <div class="text-2xl font-bold text-gray-900"><?php echo e(number_format($yearlyComparison['current_year']['total_claimed'] ?? 0)); ?></div>
...
</script><?php /**PATH C:\Users\Jhon Rhey\Downloads\Land Bank Inventory System\Land Bank Inventory System\inventory-system\resources\views\tabs\inventory-records.blade.php ENDPATH**/ ?>